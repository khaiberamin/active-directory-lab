...
- Right-click Groups, select "New", select "Group". This will prompt the Group creation pop-up. Fill out the names for each respective group: HR_Group, IT_Group, Marketing_Group, and Sales_Group

<img src="../screenshots/file-server-and-permissions/GROUPS-group-creation.png" width="600">
...
- Another way to add Users to a Group is to navigate the the User in their respective OU, right-click the User, select "Add to a group", then type to name of the group to add them to

<img src="../screenshots/file-server-and-permissions/GROUPS-adding-users-to-groups.png" width="600">
...
- Select "Add" and type the name of the group to give access to the Share
- The Group name will appear in the list of objects. Click the group name and Allow the Modify permission for this group
- Repeat this process of all 4 Shares with their respective Groups

<img src="../screenshots/file-server-and-permissions/GROUPS-giving-group-access-to-Share.png" width="600">
<img src="../screenshots/file-server-and-permissions/GROUPS-HR-share-permissions-shown.png" width="600">
...
- I logged into CLIENT01 as user Jane Doe of HR. The HR_Share was accessible, but the other 3 shares were not.
